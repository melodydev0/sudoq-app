...
class LevelMilestones {
  static const Map<int, List<String>> milestoneRewards = {
    5: ['theme_ocean', '1_free_hint'],
    10: ['frame_bronze', 'theme_forest'],
    15: ['effect_confetti', 'theme_sunset'],
    20: ['theme_midnight', 'grid_rounded'],
    25: ['frame_silver', 'theme_sakura'],
    30: ['effect_stars', '3_free_hints'],
    35: ['theme_royal'],
    40: ['grid_spaced'],
    45: ['effect_fireworks'],
    50: ['theme_neon', 'frame_gold', '5_free_hints'],
    60: ['effect_aurora'],
    65: ['grid_glow'],
    75: ['theme_gold', 'frame_platinum', '10_free_hints'],
    80: ['effect_royal'],
    90: ['grid_elite'],
    100: [
      'theme_diamond',
