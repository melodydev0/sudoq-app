...
class _SubscriptionScreenState extends ConsumerState<SubscriptionScreen>
  ...
  Future<bool> _showAccountRequiredDialog() async {
    ...
    if (result == true) {
      // Sign-in succeeded. The user's Apple/Google account may already have an
      // active subscription (restored silently by EntitlementService on sign-in).
      // In that case, close the paywall and return to the previous screen
      // instead of prompting them to purchase again.
