...
// NOTE: Read lazily inside functions. In Firebase Functions v2 secrets are
// only available during execution, not at module load. Top-level reads are
// always empty even when `secrets: ["APPLE_SHARED_SECRET"]` is declared.
const getAppleSharedSecret = () => process.env.APPLE_SHARED_SECRET || "";
